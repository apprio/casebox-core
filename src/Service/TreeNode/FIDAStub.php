...
class FIDAStub extends Base
{
    ...
    protected function getRootNodes()
    {
        ...
        $p['fq'] = $this->fq;
        $p['fl'] = 'id,firstname_s,lastname_s,clientstatus_i,fidastatus_s,fematier_i,location_i,assignee_i,cid,cdate,task_d_closed,case_status,fematier,name,phonenumber_s,location_type_s,outreachattemptdate_dt,city_s,zipcode_s';
		    $p['rows'] = 0;
    ...
    protected function getAssigneeTasks()
    {
        ...
        $p['fq'][] = 'fidastatus_s:('.str_replace('&&','/',str_replace(' ', '\ ', $user_id)).')';
		    $p['fl'] = 'id,firstname_s,lastname_s,clientstatus_i,fidastatus_s,fematier_i,location_i,assignee_i,cid,cdate,task_d_closed,case_status,fematier,name,phonenumber_s,location_type_s,_phonenumber,outreachattemptdate_dt,city_s,zipcode_s';
        $s = new Search();
