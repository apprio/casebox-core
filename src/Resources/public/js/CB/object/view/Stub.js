...
Ext.define('CB.object.view.Stub', {
  extend: 'Ext.Panel'
,alias: 'widget.CBObjectViewStub'
,api: 'CB_Objects.getPluginsData'
 ...
 Ext.apply(this, {
  ...
  ,onLoadData: function(r, e) {
    ...
    var assessmentMenu = '510,533,553,482,455,1120,505,559,489,440,656,1175,651,172,3114'; //removed 1120 FEMA
    var taskMenu = '7';
    var recoveryMenu = '527'
    var referralMenu = '607';
    var outreachMenu = '247979';
      ...
      Ext.iterate(
        ...
        ,function(k, v, o) {
          ...
          else
          {
           ...
           if (outreachMenu.indexOf(k.template_id) >=  0)
           {
            outreachData.data.push(k);
           }
      }
        ,this
      );
    ...
    content.createMenu = outreachMenu;
    content.updateTitle('Add Outreach Attempt');
    content.onLoadData(outreachData);
    c.add(content);

    content = Ext.create('CBObjectPluginObjectProperties',{params:params});
    r.data.objectProperties.data.preview[0] = r.data.objectProperties.data.preview[8];
    content.onLoadData(r.data.objectProperties);
    c.add(content);
